/*
Implementation of Koiliaris & Xu's algorithm described in "A Faster Pseudopolynomial Time Algorithm for Subset Sum" (2016)
https://arxiv.org/pdf/1507.02318.pdf
This implementation hasn't been finished due to an improved Koiliaris & Xu's algorithm implemented in koiliaris_xu_ssum.cpp
*/
...
//	std::vector<std::pair<int, int>> min_add = minkowski_sum_fft2d(ssum_card_set1_f, ssum_card_set2_f, alpha * (right_bound - left_bound));
...
////	return minkowski_add_2d(left_ssum_card_set, right_ssum_card_set, bound);
////}
//
//
//
...
//	return minkowski_sum_fft(left_ssums, right_ssums, ssum_bound);
//}
//
///* Lemma 2.14 */
///*
...
//* 
//*/
//std::pair<bool, double> koiliaris_xu_ssum_2016(const std::vector<int>& set, int target, double r0=-1) {
...
//		all_ssums = minkowski_sum_fft(all_ssums, ssums, target);
//	}
//
